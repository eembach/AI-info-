...
class NHLModel_v3_0_2:
    ...
    def analyze_slate(self, games: List[Game]) -> List[Pick]:
        picks = []
        print(f"Running Model v3.0.2 (Saves Under Dominance) Analysis for {len(games)} games...")
        for game in games:
...
def main():
    ...
    model = NHLModel_v3_0_2()
    picks = model.analyze_slate(games)

    print("\n🏆 MASTER PICK BOARD (Model v3.0.2 - Saves Under Dominance) 🏆")
