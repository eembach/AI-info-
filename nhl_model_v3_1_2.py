        ...
        for p in game.key_players:
            ...
            if "Playmaker" in p.status_note or "Scorer" in p.status_note:
                ...
                if green_light_1_5:
                    ...
                    # v3.1.2: KILL SWITCH on Points Unders
                    # Fading active scorers (Robertson, etc.) is a structural leak.
                    # We only fade players who generate almost no offense (< 0.6 PPG)
                    if p.avg_points > 0.6: 
                        pass 
